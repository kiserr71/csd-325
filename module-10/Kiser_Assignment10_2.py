...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        todo1 = tk.Label(self.tasks_frame, text="--- Add Items Here --- RIGHT CLICK ITEM TO DELETE",
            bg="dodger blue", fg="black", pady=10)
        ...
        self.colour_schemes = [{"bg": "dodger blue", "fg": "black"}, {"bg": "orange", "fg": \
            "black"}]
        ...
        #This code adds a "File" menu and a single option to "Exit".
